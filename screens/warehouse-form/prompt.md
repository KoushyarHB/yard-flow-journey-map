# Warehouse — implementation prompt
...
## Goal
Warehouse screen in the **Administration** cluster. Used by Admin, Manager.

## Route & placement
- Route: `/yard-flow/admin/warehouses/new`
- Sidebar: Yard Flow (L1 rail) → Administration (L2 cluster) → route cluster → Warehouse (L4)
- Breadcrumb: Yard Flow / Admin / Warehouse
...
- Endpoints:
  ...
  |--------|------|---------|-------------|--------------|
| `POST` | `/warehouses` | Warehouse action | — | — |
| `PATCH` | `/warehouses/{id}` | Warehouse action | — | — |
- Auth: mutations require `actor` field. Permissions: .


## Data model (frontend types to add)
- `src/lib/types/yard-flow/response/warehouse-form/get-warehouse-form.dto.ts`
- `src/lib/types/yard-flow/request/warehouse-form/create-warehouse-form-request.dto.ts`
...
- Validation: Zod schema in `src/lib/schema/yard-flow/warehouse-formSchema.ts`.

## Files to create
- `src/app/[locale]/yard-flow/...` — thin route wrapper
- `src/components/pages/yard-flow/administration/warehouse-form/`
- `src/services/yard-flow/yardlocationService.ts`
- `src/hooks/yard-flow/useWarehouseMutations.ts`
